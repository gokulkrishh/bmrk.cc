...
const SettingsLink = ({ className }: { className?: string }) => (
  <NavLink
    ...
    title="Settings"
  >
    <Settings className="w-6 h-6 text-black group-hover:scale-95 duration-150 transition-transform" />
  </NavLink>
);
    ...
    <nav className="flex fixed sm:top-0 max-sm:bottom-0 max-sm:bg-neutral-100 max-sm:h-[86px] z-10 justify-center sm:justify-between max-sm:px-4 sm:flex-col sm:h-full bottom-t sm:border-r sm:w-[70px] w-full border-neutral-200">
      <div className="flex sm:flex-col items-center max-sm:pb-[calc(env(safe-area-inset-bottom)/3)] max-sm:gap-6 gap-3 text-neutral-900">
        ...
        <NavLink href={'/'} title="Home">
          <HomeIcon className="w-6 h-6 text-black group-hover:scale-95 duration-150 transition-transform" />
        </NavLink>
        <Search />
        <NavLink
          ...
          title="Favorites"
        >
          <StarIcon className="w-6 h-6 text-black group-hover:scale-95 duration-150 transition-transform" />
        </NavLink>
        <NavLink className="max-sm:order-4" href={'/tags'} title="Tags">
          <Tags className="w-6 h-6 text-black group-hover:scale-95 duration-150 transition-transform" />
        </NavLink>
